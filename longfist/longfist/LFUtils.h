...
inline JournalPair getMdJournalPair(short source)
{
	switch(source)
	{
		...
		case 2:
			return {"/shared/kungfu/journal/MD/Simu/", "MD_Simu"};
		case 15:
...
inline JournalPair getMdRawJournalPair(short source)
{
	switch(source)
	{
		...
		case 2:
			return {"/shared/kungfu/journal/MD_RAW/Simu/", "MDRAW_Simu"};
		case 15:
...
inline JournalPair getTdJournalPair(short source)
{
	switch(source)
	{
		...
		case 2:
			return {"/shared/kungfu/journal/TD/Simu/", "TD_Simu"};
		case 15:
...
inline JournalPair getTdSendJournalPair(short source)
{
	switch(source)
	{
		...
		case 2:
			return {"/shared/kungfu/journal/TD_SEND/Simu/", "TD_SEND_Simu"};
		case 15:
...
inline JournalPair getTdRawJournalPair(short source)
{
	switch(source)
	{
		...
		case 2:
			return {"/shared/kungfu/journal/TD_RAW/Simu/", "TD_RAW_Simu"};
		case 15:
...
inline JournalPair getTdQJournalPair(short source)
{
	switch(source)
	{
		...
		case 2:
			return {"/shared/kungfu/journal/TD_Q/Simu/", "TD_Q_Simu"};
		case 15:
